...
export const UI = {
  EN: { locale: 'en-GB', today: 'Today', music: 'Music', price: 'Price', artists: 'Artists', from: 'From', until: 'Until',
  ...
  DE: { locale: 'de', today: 'Heute', music: 'Musik', price: 'Preis', artists: 'Künstler', from: 'Ab', until: 'Bis',
  ...
  ES: { locale: 'es-419', today: 'Hoy', music: 'Música', price: 'Precio', artists: 'Artistas', from: 'Desde', until: 'Hasta',
  ...
  PT: { locale: 'pt', today: 'Hoje', music: 'Música', price: 'Preço', artists: 'Artistas', from: 'A partir de', until: 'Até',
  ...
  IT: { locale: 'it', today: 'Oggi', music: 'Musica', price: 'Prezzo', artists: 'Artisti', from: 'Dal', until: 'Fino al',
  ...
  RU: { locale: 'ru', today: 'Сегодня', music: 'Музыка', price: 'Цена', artists: 'Артисты', from: 'С', until: 'До',
  ...
  UK: { locale: 'uk', today: 'Сьогодні', music: 'Музика', price: 'Ціна', artists: 'Артисти', from: 'З', until: 'До',
  ...
  ZH: { locale: 'zh', today: '今天', music: '音乐', price: '价格', artists: '艺术家', from: '自', until: '至',
  ...
  JA: { locale: 'ja', today: '今日', music: '音楽', price: '料金', artists: 'アーティスト', from: '開始', until: '終了',
  ...
  KO: { locale: 'ko', today: '오늘', music: '음악', price: '가격', artists: '아티스트', from: '시작', until: '종료',
  ...
  FR: { locale: 'fr', today: "Aujourd'hui", music: 'Musique', price: 'Prix', artists: 'Artistes', from: 'À partir du', until: "Jusqu'au",
