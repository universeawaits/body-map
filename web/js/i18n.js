...
export const UI = {
  EN: { locale: 'en-GB', today: 'Today', music: 'Music', artists: 'Artists', from: 'From', until: 'Until',
  ...
  DE: { locale: 'de', today: 'Heute', music: 'Musik', artists: 'Künstler', from: 'Ab', until: 'Bis',
  ...
  ES: { locale: 'es-419', today: 'Hoy', music: 'Música', artists: 'Artistas', from: 'Desde', until: 'Hasta',
  ...
  PT: { locale: 'pt', today: 'Hoje', music: 'Música', artists: 'Artistas', from: 'A partir de', until: 'Até',
  ...
  IT: { locale: 'it', today: 'Oggi', music: 'Musica', artists: 'Artisti', from: 'Dal', until: 'Fino al',
  ...
  RU: { locale: 'ru', today: 'Сегодня', music: 'Музыка', artists: 'Артисты', from: 'С', until: 'До',
  ...
  UK: { locale: 'uk', today: 'Сьогодні', music: 'Музика', artists: 'Артисти', from: 'З', until: 'До',
  ...
  ZH: { locale: 'zh', today: '今天', music: '音乐', artists: '艺术家', from: '自', until: '至',
  ...
  JA: { locale: 'ja', today: '今日', music: '音楽', artists: 'アーティスト', from: '開始', until: '終了',
  ...
  KO: { locale: 'ko', today: '오늘', music: '음악', artists: '아티스트', from: '시작', until: '종료',
  ...
  FR: { locale: 'fr', today: "Aujourd'hui", music: 'Musique', artists: 'Artistes', from: 'À partir du', until: "Jusqu'au",
